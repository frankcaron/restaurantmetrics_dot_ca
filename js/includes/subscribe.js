    ...
    $("#subscribeform").submit(function(e) {
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                error: function(d) {
                    $('#js-subscribe-result').fadeIn('slow').html('<p class="help-block text-danger">Oops! We couldn\'t deliver your email. Please try again later.</p>').delay(3000).fadeOut('slow');
                    $("#js-subscribe-btn").attr("disabled", false);
                }
            });
            return false;
